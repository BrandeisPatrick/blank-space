/**
 * DiagonalWaves component
 * Renders 5 diagonal parallel waves flowing from bottom-left to top-right
 * with random width variations
 */

export const DiagonalWaves = ({ opacities = [0.4, 0.35, 0.45, 0.4, 0.35] }) => {
  // Wave path definitions with varying opacity
  const waves = [
    {
      id: 'wave-1',
