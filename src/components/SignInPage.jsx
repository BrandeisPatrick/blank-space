...
export const SignInPage = ({ onNavigateToMain, onSignIn }) => {
  const { mode } = useTheme();
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button
            type="button"
            onClick={() => showNotImplementedWarning('Google sign-in')}
            style={{
              flex: 1,
              padding: theme.spacing.md,
              fontSize: theme.typography.fontSize.sm,
          ...
          <button
            type="button"
            onClick={() => showNotImplementedWarning('GitHub sign-in')}
            style={{
              flex: 1,
              padding: theme.spacing.md,
              fontSize: theme.typography.fontSize.sm,
        ...
        <div style={{
          ...
          <p style={{
            ...
            <button
              ...
              onClick={() => showNotImplementedWarning('Sign up')}
            >
              Sign up
            </button>
          </p>
